...
Построим дашборд в Redash для отдела продаж и выведем основные показатели: например, выручку по странам, дням, топ товаров, и другие графики, которые вы считаете необходимыми для отражения текущего положения дел. И самостоятельно поставим себе задачу :)  
...
<p align="center">
  ...
  <img width="1060" height="250" src="https://github.com/Juldid/Redash/blob/main/Redash%203.JPG">
