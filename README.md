...
Построим дашборд в Redash для отдела продаж и выведем основные показатели: выручку по странам, дням, топ товаров, и другие графики, которые посчитаем необходимыми для отражения текущего положения дел. И самостоятельно поставим себе задачу :)  
